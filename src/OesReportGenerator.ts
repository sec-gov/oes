...
const DP_NAME: { [key: string]: string } = {
	"S": "SAMPLE", "A": "NYSE American", "Z": "BZX", "Y": "BYX", "B": "Nasdaq BX", "M": "NYSE Texas", "C": "NYSE National", "J": "EDGA", "K": "EDGX", "Q": "NASDAQ", "T": "FINRA", "N": "NYSE", "P": "NYSE ARCA", "X": "Nasdaq PSX", "V": "IEX", "L": "LTSE", "H": "MIAX", "U": "MEMX", "G": "24X"
}
